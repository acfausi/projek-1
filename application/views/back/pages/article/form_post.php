      ...
      <div id="content-wrapper" class="d-flex flex-column">
         ...
         <div id="content">
            ...
            <div class="container">
               ...
               <div class="form-group row">
                  <div class="col">
                     <label for="featured" class="col-form-label">BERITA</label>
                  ...
                  <div class="col">
                     <label for="choice" class="col-form-label">PILIHAN</label>
                  ...
                  <div class="col">
                     <label for="thread" class="col-form-label">TERKINI</label>
